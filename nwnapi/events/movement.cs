namespace NWN.Events
{
    public class WalkInputEvent : NWNXEvent
    {
        ...
        public WalkInputEvent(string script) { EventType = script; }
        ...
        public static void EventHandler(string script)
        {
            ...
            switch (script)
            {
                case BEFORE_INPUT_WALK_TO_WAYPOINT:	BeforeInputWaypoint(e); break;
                case AFTER_INPUT_WALK_TO_WAYPOINT:	AfterInputWaypoint(e); break;
            }
        }
    }
    ...
    public class ForceMoveEvent : NWNXEvent
    {
        ...
        public ForceMoveEvent(string script) { EventType = script; }
        ...
        public static void EventHandler(string script)
        {
            ...
            switch (script)
            {
                case BEFORE_INPUT_FORCE_MOVE_TO_OBJECT:	BeforeForceMove(e); break;
                case AFTER_INPUT_FORCE_MOVE_TO_OBJECT:	AfterForceMove(e); break;
            }
        }
    }
    ...
    public class MaterialChangeEvent : NWNXEvent
    {
        ...
        public MaterialChangeEvent(string script) { EventType = script; }
        ...
        public static void EventHandler(string script)
        {
            ...
            switch (script)
            {
                case BEFORE_MATERIALCHANGE:	BeforeMaterialChange(e); break;
                case AFTER_MATERIALCHANGE:	AfterMaterialChange(e); break;
            }
        }
    }
}