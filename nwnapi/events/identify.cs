namespace NWN.Events
{
    public class LoreEvent : NWNXEvent
    {
        ...
        public LoreEvent(string script) { EventType = script; }
        ...
        public static void EventHandler(string script)
        {
            ...
            switch (script)
            {
                case BEFORE_USE_LORE:   BeforeUseLore(e); break;
                case AFTER_USE_LORE:    AfterUseLore(e); break;
                case BEFORE_PAY_TO_ID:  BeforePayToIdentify(e); break;
                case AFTER_PAY_TO_ID:   AfterPayToIdentify(e); break;
                default: break;
            }
        }
    }
