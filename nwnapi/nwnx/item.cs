...
namespace NWN.NWNX
{
    public static class Item
    {
        ...
        {
            Internal.NativeFunctions.nwnxSetFunction(PluginName, "SetBaseGoldPieceValue");
        ...
        {
            Internal.NativeFunctions.nwnxSetFunction(PluginName, "SetAddGoldPieceValue");
        ...
        {
            Internal.NativeFunctions.nwnxSetFunction(PluginName, "GetBaseGoldPieceValue");
        ...
        {
            Internal.NativeFunctions.nwnxSetFunction(PluginName, "GetAddGoldPieceValue");
        ...
        {
            Internal.NativeFunctions.nwnxSetFunction(PluginName, "SetBaseItemType");
        ...
        {
            Internal.NativeFunctions.nwnxSetFunction(PluginName, "SetItemAppearance");
        ...
        {
            Internal.NativeFunctions.nwnxSetFunction(PluginName, "GetEntireItemAppearance");
        ...
        {
            Internal.NativeFunctions.nwnxSetFunction(PluginName, "RestoreItemAppearance");
        ...
        {
            Internal.NativeFunctions.nwnxSetFunction(PluginName, "GetBaseArmorClass");
        ...
        {
            Internal.NativeFunctions.nwnxSetFunction(PluginName, "GetMinEquipLevel");
