...
namespace NWN
{
    public class NWModule : NWObjectBase
    {
        ...
        public bool IsDay   => NWScript.GetIsDay()   == 1;
        public bool IsNight => NWScript.GetIsNight() == 1;
        public bool IsDawn  => NWScript.GetIsDawn()  == 1;
        public bool IsDusk  => NWScript.GetIsDusk()  == 1;
