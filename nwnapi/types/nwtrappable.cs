namespace NWN
{
    public class NWTrappable : NWObject
    {
        ...
        public virtual bool IsTrapFlagged
        {
            get => NWScript.GetTrapFlagged(this) == 1;
           // set => NWScript.SetTrapFlagged(this, value ? 1 : 0);
        }

        public virtual int TrapBaseType
        {
            get => NWScript.GetTrapBaseType(this);
        ...
        public virtual NWObject TrapCreator
        {
            get => NWScript.GetTrapCreator(this).AsObject();
